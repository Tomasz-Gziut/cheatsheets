        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-4">
            <div className="prose prose-sm md:prose-base max-w-none">
              ...
              <p className="text-sm md:text-base leading-relaxed">
                <strong>
                  Omów System sojuszy i plany wojenne przed 1914 r.
                </strong>{" "}
                Trójprzymierze vs Trójporozumienie, składy sojuszy i przyczyny
                ich zawarcia
              </p>
              <p className="text-sm md:text-base leading-relaxed">
                <strong>
                  Wskaż Najważniejsze wydarzenia i bitwy 1914–1916
                </strong>{" "}
